...
function shiftHexHue(hex, hueDelta, lightnessDelta = 0) {
...
export class FpsDisplay {
    ...
    constructor(container, title) {
        ...
        this.#intervalId = setInterval(() => this.#drawGraph(), 1000);
    }
    #drawGraph() {
        ...
        ctx.drawImage(this.#canvas, GRAPH_X + PR, GRAPH_Y, GRAPH_WIDTH - PR, GRAPH_HEIGHT, GRAPH_X, GRAPH_Y, GRAPH_WIDTH - PR, GRAPH_HEIGHT);
        ...
        ctx.fillStyle = this.#bg;
        ctx.globalAlpha = 0.9;
        const max = this.#max || 1; // avoid divide-by-zero early on
